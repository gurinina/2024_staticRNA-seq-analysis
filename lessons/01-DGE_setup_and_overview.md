...
![Alt text](img/rnaseq_full_workflow.png){ width=400px }
...
![Alt text](img/model_mov10.png){ width=400px }
...
![Alt text](img/dataset.png){ width=400px }
...
![Alt text](img/deseq_counts_overview.png){ width=600px }
...
![Alt text](img/foldchange_heatmap.png){ width=200px }
...
![Alt text](img/de_variation.png){ width=500px }
...
![Alt text](img/de_norm_counts_var.png){ width=400px }
...
![Alt text](img/deseq_counts_distribution.png){ width=400px }
...
![Alt text](img/deseq_counts_distribution_zoomed.png){ width=400px }
...
![Alt text](img/poisson-distribution-formula.png){ width=300px }
...
![Alt text](img/de_replicates_img.png){ width=500px }
...
![Alt text](img/venn.png){ width=300px }
...
![Alt text](img/deseq_workflow_full_2018.png){ width=500px }
