...
![Alt text](img/deseq2_workflow_separate_2018.png){ width=400px }
...
![Alt text](img/NB_model_formula.png){ width=600px }
...
![Alt text](img/NB_model_formula_betas.png){ width=600px }
...
![Alt text](img/deseq2_shrunken_lfc.png){ width=500px }
...
![Alt text](img/maplot_unshrunken.png){ width=600px }
...
![Alt text](img/MA_plot.png){ width=600px }
