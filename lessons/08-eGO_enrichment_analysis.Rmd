...
![Alt text](img/go_proportions.png){ width=600px }

![Alt text](img/go_proportions_table3.png){ width=600px }
...
![Alt text](img/mov10oe_dotplot.png){ width=600px }
...
![Alt text](img/mov10oe_enrichmap.png){ width=800px }
...
![Alt text](img/mov10oe_cnetplot.png){ width=800px }
...
![Alt text](img/gsea_theory.png){ width=600px }
...
```{r}
vis = GOenrichment::visSetup(hresp$enrichInfo,hresp$edgeMat)
names(vis)
```

Now we use runNetwork to view the map: 

```{r interactive_network, echo=FALSE, results='asis'}
